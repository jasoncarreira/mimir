...
export const neonTerminalSkin = {
  ...
  tokens: {
    ...
    colorTimelineReasoning: "#6fe0c0",
    colorTimelineReasoningBackground: "#071f1a",
    colorTimelineToolCall: "#e0b24a",
    colorTimelineToolCallBackground: "#241d08",
    colorTimelineToolResult: "#3fe07a",
    colorTimelineToolResultBackground: "#0c2417",
    colorTriggerSagaSessionEnd: "#c9a3ff",
    colorTriggerScheduledTick: "#e0b24a",
    colorTriggerPoller: "#6fe0c0",
    colorTriggerUserMessage: "#7fb6ff",
    colorTriggerSynthesis: "#5be88f",
    colorTriggerHeartbeat: "#ff8fb0",
    colorTriggerClaudeCodeSpawn: "#a6a6ff",
    colorTriggerShellJobComplete: "#8fd6e6",
