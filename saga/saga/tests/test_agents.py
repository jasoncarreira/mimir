...
class TestRegisterAgent:
    def test_register_new_agent(self):
        from saga.agents import register_agent
...
class TestListAgents:
    def test_list_empty(self):
        from saga.agents import list_agents
        agents = list_agents()
        assert isinstance(agents, list)

    def test_list_after_register(self):
        from saga.agents import register_agent, list_agents
...
class TestAgentStats:
    def test_stats_empty_agent(self):
        from saga.agents import register_agent, agent_stats
...
class TestShareAtom:
    def test_share_nonexistent_atom(self):
        from saga.agents import register_agent, share_atom
...
class TestAgentIsolation:
    def test_store_with_agent_id(self):
        from saga.core import store_atom, get_db
