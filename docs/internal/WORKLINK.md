...
- **Tool-pin inventory (external-toolchain drift).** `worklink.yaml`
  ...
  | gogcli | `integration-cli` | GitHub release/tag `steipete/gogcli` | `v0.30.0` | gmail-poller optional-skill `dockerfile.fragment` | `gog --version` | Medium: Gmail/Calendar helper drift can break polling independent of Worklink coding backends. |
