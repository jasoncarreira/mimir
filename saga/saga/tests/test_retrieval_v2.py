...
class TestExtractQueryEntities:
    def test_extracts_capitalized(self):
        from saga.retrieval_v2 import extract_query_entities
...
class TestDetectTemporalScope:
    def test_today(self):
        from saga.retrieval_v2 import detect_temporal_scope
...
class TestApplyTemporalFilter:
    def test_filters_old(self):
        from saga.retrieval_v2 import apply_temporal_filter
...
class TestFeedbackPipeline:
    def test_init_feedback_table(self):
        ...
        from saga.retrieval_v2 import init_feedback_table
    ...
    def test_log_and_get_usefulness(self):
        from saga.core import get_db, run_migrations
        from saga.retrieval_v2 import log_retrieval_feedback, get_atom_usefulness
