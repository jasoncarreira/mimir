...
class Config:
    ...
    # billing). Every provider now supports enforcement; the historical
    # ``claude-code:`` startup refusal was removed once #910 plumbed the
    # per-turn AuthContext across the SDK hook boundary.
    model_spec: str
