...
class TestTwoTierReturn:
    ...
    async def test_returns_dict_shape(self, env, monkeypatch):
        ...
        raw_id = saga.core.store_atom("I picked up a Sony A7 III last week")
    ...
    async def test_observation_below_confidence_floor_dropped(self, env, monkeypatch):
        ...
        raw_id = saga.core.store_atom("a raw fact")
...
class TestEvidenceBoost:
    ...
    async def test_evidenced_by_lifts_raw_atom(self, env, monkeypatch):
        ...
        evidence_id = saga.core.store_atom("I got my Sony A7 III last week")
        noise_id = saga.core.store_atom("talked about scheduling a dentist visit")
...
class TestMissingEvidenceBaseScore:
    ...
    async def test_missing_atom_with_zero_similarity_lands_at_or_below_in_pool_peer(
        ...
        in_pool_id = saga.core.store_atom("I love taking photos")
        missing_id = saga.core.store_atom("unrelated content about cooking")
...
class TestMissingRefScorePivot:
    ...
    def _setup_three_raws_one_obs(self, env, monkeypatch):
        ...
        a_id = saga.core.store_atom("Picked up a Leica M3 last weekend")
        b_id = saga.core.store_atom("Found a Nikon F at the flea market")
        c_id = saga.core.store_atom("Restored my dad's Canonet QL17")
        missing_id = saga.core.store_atom(
...
class TestKeywordOnlyTierBackfill:
    ...
    async def test_keyword_only_atom_gets_classified(self, env, monkeypatch):
        ...
        sem_id = saga.core.store_atom("semantic match for the query")
        kw_only_id = saga.core.store_atom("keyword-only match content")
