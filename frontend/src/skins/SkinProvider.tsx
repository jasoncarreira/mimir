...
const tokenCssVariableNames = {
  ...
  colorTimelineReasoningBackground: "--mimir-color-timeline-reasoning-background",
  colorTimelineToolCall: "--mimir-color-timeline-tool-call",
  colorTimelineToolCallBackground: "--mimir-color-timeline-tool-call-background",
  colorTimelineToolResult: "--mimir-color-timeline-tool-result",
  colorTimelineToolResultBackground: "--mimir-color-timeline-tool-result-background",
