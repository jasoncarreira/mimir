...
export type SkinTokenName =
  ...
  | "colorTriggerSagaSessionEnd"
  | "colorTriggerScheduledTick"
  | "colorTriggerPoller"
  | "colorTriggerUserMessage"
  | "colorTriggerSynthesis"
  | "colorTriggerHeartbeat"
  | "colorTriggerClaudeCodeSpawn"
  | "colorTriggerShellJobComplete"
  | "colorCodeBackground"
  | "colorCodeText"
  | "colorFocusRing"
  | "fontFamilyBase"
