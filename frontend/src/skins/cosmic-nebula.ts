...
export const cosmicNebulaSkin = {
  ...
  tokens: {
    ...
    colorTriggerSagaSessionEnd: "#d99bff",
    colorTriggerScheduledTick: "#ffb657",
    colorTriggerPoller: "#3ee0a0",
    colorTriggerUserMessage: "#4dc8ff",
    colorTriggerSynthesis: "#8ee65c",
    colorTriggerHeartbeat: "#ff839a",
    colorTriggerClaudeCodeSpawn: "#aaa6ff",
    colorTriggerShellJobComplete: "#69d5e6",
