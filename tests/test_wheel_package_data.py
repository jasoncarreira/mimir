...
CRITICAL_RUNTIME_DATA = (
    ...
    "mimir/skills/tool-pin-drift/check_tool_pins.py",  # declared immutable drift script
    "mimir/skills/tool-pin-drift/targets.json",  # source-controlled drift inventory
