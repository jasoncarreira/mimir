...
class TestTimeBuckets:
    def test_morning_bucket(self):
        from saga.prediction import _hour_in_bucket
    ...
    def test_bucket_hour_range(self):
        from saga.prediction import _bucket_hour_range
...
class TestPredict:
    def test_returns_valid_structure(self):
        ...
        with patch("saga.prediction.dry_retrieve", return_value=[]):
...
class TestLearnFromSession:
    def test_records_co_retrieval_pairs(self):
        ...
        with patch("saga.core._ensure_co_retrieval_table"):
            with patch("saga.core._log_co_retrieval") as mock_log:
...
class TestTemporalTracking:
    def test_temporal_tracking(self):
        from saga.prediction import track_temporal_pattern
...
class TestCoRetrievalTracking:
    def test_co_retrieval_tracking(self):
        from saga.prediction import track_co_retrievals
        conn = _make_temporal_db()
...
class TestPredictContext:
    ...
    def disable_warmup(self, monkeypatch):
        ...
        import saga.prediction as pred_mod
