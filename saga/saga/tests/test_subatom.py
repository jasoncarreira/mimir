...
def temp_db(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("saga.embeddings.embed_text", lambda t: fake_emb)
    monkeypatch.setattr("saga.embeddings.batch_embed_texts",
...
class TestSplitSentences:
    def test_basic_split(self):
        from saga.subatom import split_sentences
...
class TestDeduplicate:
    def test_removes_similar(self):
        from saga.subatom import deduplicate_sentences
...
class TestExtractRelevantSentences:
    def test_returns_scored_sentences(self):
        ...
        from saga.subatom import extract_relevant_sentences
...
class TestPackUnpackEmbedding:
    def test_round_trip(self):
        from saga.subatom import _pack_embedding, _unpack_embedding
...
class TestEstimateTokens:
    def test_basic_estimate(self):
        from saga.subatom import _estimate_tokens
...
class TestCacheSentenceEmbeddings:
    def test_caches_and_skips_existing(self):
        from saga.core import get_db, run_migrations, store_atom
        from saga.subatom import cache_sentence_embeddings
...
class TestCacheAllSentences:
    def test_caches_all_active(self):
        from saga.core import get_db, run_migrations, store_atom
        from saga.subatom import cache_all_sentences
