...
from saga.core import store_atom, retrieve, hybrid_retrieve, get_stats, metamemory_query
from saga.triples import extract_and_store, hybrid_retrieve_with_triples
...
async def main() -> None:
    ...
    from saga.triples import retrieve_by_entity
    ...
    hybrid = await hybrid_retrieve_with_triples("user preferences", token_budget=200)
