...
class TestSchemaMigrations:
    def test_get_schema_version(self):
        from saga.core import get_db, get_schema_version
    ...
    def test_run_migrations(self):
        from saga.core import run_migrations
...
class TestRelations:
    def test_add_and_get_atom_relations(self):
        from saga.core import add_atom_relation, get_atom_relations
...
class TestAdvancedRetrieval:
    def test_retrieve_diverse(self):
        from saga.core import retrieve_diverse
    ...
    def test_retrieve_with_emotion(self):
        from saga.core import retrieve_with_emotion
    ...
    def test_cached_embed_query(self):
        from saga.core import cached_embed_query
        emb = cached_embed_query("test query")
        assert isinstance(emb, list)
        assert len(emb) > 0

    def test_batch_retrieve(self):
        from saga.core import batch_retrieve
...
class TestKnowledgeManagement:
    def test_detect_knowledge_gaps(self):
        from saga.core import detect_knowledge_gaps
        from saga.triples import init_triples_schema
        from saga.core import get_db
        conn = get_db()
        init_triples_schema(conn)
    ...
    def test_estimate_importance(self):
        from saga.core import estimate_importance
    ...
    def test_find_merge_candidates(self):
        from saga.core import find_merge_candidates
    ...
    def test_split_atom(self):
        from saga.core import split_atom
    ...
    def test_summarize_atom(self):
        from saga.core import summarize_atom
        aid = _store(
    ...
    def test_save_and_get_atom_versions(self):
        from saga.core import save_atom_version, get_atom_versions
...
class TestNegativeKnowledge:
    ...
    def test_expire_negatives(self):
        from saga.core import expire_negatives
...
class TestProvenance:
    def test_log_and_get_provenance(self):
        from saga.core import log_provenance, get_provenance
    ...
    def test_provenance_empty(self):
        from saga.core import get_provenance
        _store("Setup DB")
...
class TestHooks:
    def test_register_and_unregister_hook(self):
        from saga.core import register_hook, unregister_hook
...
class TestEmotionalDrift:
    def test_emotional_drift(self):
        from saga.core import emotional_drift
...
class TestMetamemory:
    def test_metamemory_query(self):
        from saga.core import metamemory_query
        from saga.triples import init_triples_schema
        from saga.core import get_db
        conn = get_db()
        init_triples_schema(conn)
...
class TestPinning:
    def test_pin_and_unpin_atom(self):
        from saga.core import pin_atom, unpin_atom, list_pinned, is_pinned
    ...
    def test_is_pinned(self):
        from saga.core import is_pinned
    ...
    def test_pin_nonexistent(self):
        from saga.core import pin_atom
        _store("Setup DB")
...
class TestForgetting:
    def test_log_forgetting(self):
        from saga.core import log_forgetting, get_db
    ...
    def test_get_forgetting_history(self):
        from saga.core import log_forgetting, get_forgetting_history, get_db
    ...
    def test_get_recent_forgetting(self):
        from saga.core import log_forgetting, get_recent_forgetting, get_db
...
class TestCacheFunctions:
    def test_clear_cache(self):
        from saga.core import clear_cache, get_cache_stats, cached_embed_query
        # Populate cache
    ...
    def test_get_cache_stats(self):
        from saga.core import get_cache_stats
        stats = get_cache_stats()
...
class TestContextQuality:
    def test_score_context_quality(self, metrics_db):
        from saga.core import score_context_quality, retrieve
...
class TestConfidence:
    def test_update_confidence_from_evidence(self):
        from saga.core import update_confidence_from_evidence
        from saga.triples import init_triples_schema
        from saga.core import get_db
        conn = get_db()
        init_triples_schema(conn)
    ...
    def test_decay_confidence(self):
        from saga.core import decay_confidence
...
class TestAnalysis:
    def test_compute_retrieval_adjustments(self, metrics_db):
        from saga.core import compute_retrieval_adjustments
    ...
    def test_analyze_access_patterns(self, metrics_db):
        from saga.core import analyze_access_patterns
...
class TestOutcomeFunctions:
    ...
    def test_get_outcome_history(self):
        from saga.core import record_outcome, get_outcome_history
    ...
    def test_get_outcome_history_summary(self):
        from saga.core import get_outcome_history
