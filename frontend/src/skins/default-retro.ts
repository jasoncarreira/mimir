...
export const defaultRetroSkin = {
  ...
  tokens: {
    ...
    colorTimelineReasoning: "#315f7d",
    colorTimelineReasoningBackground: "#e4f1f8",
    colorTimelineToolCall: "#7a5b1d",
    colorTimelineToolCallBackground: "#fbf1d8",
    colorTimelineToolResult: "#326b48",
    colorTimelineToolResultBackground: "#e4f4e9",
    colorTriggerSagaSessionEnd: "#68428e",
    colorTriggerScheduledTick: "#7a5b1d",
    colorTriggerPoller: "#326b48",
    colorTriggerUserMessage: "#315f7d",
    colorTriggerSynthesis: "#3f6330",
    colorTriggerHeartbeat: "#8b3a3a",
    colorTriggerClaudeCodeSpawn: "#4f4f92",
    colorTriggerShellJobComplete: "#216674",
