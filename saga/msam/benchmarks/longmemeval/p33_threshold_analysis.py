...
Usage:
    ...
    PYTHONPATH=. python -m msam.benchmarks.longmemeval.p33_threshold_analysis
...
from .config import DATASET_PATH, BENCH_MSAM_CONFIG
...
def main():
    ...
    # Reload config so msam.embeddings picks up the bench config
    ...
    from msam.embeddings import get_provider, embed_query
    # Force embeddings module to re-resolve its provider after reload.
    import msam.embeddings as _emb
