...
from saga.config import reload_config, get_config
reload_config()
...
from saga.core import get_db, run_migrations, DB_PATH
from saga.triples import init_triples_schema
from saga.benchmarks.synthetic_dataset import generate_dataset, populate_db, generate_ground_truth
import saga.benchmarks.benchmark as _bench_mod
from saga.benchmarks.benchmark import (
...
saga.core.embed_text = _content_embedding
saga.core.embed_query = _content_embedding
saga.core.cached_embed_query = _content_embedding
saga.embeddings.embed_text = _content_embedding
_bench_mod.embed_query = _content_embedding
# Also patch the import alias used by retrieval_v2 if present
if hasattr(saga.core, '_cached_embed_query_import'):
    saga.core._cached_embed_query_import = _content_embedding
