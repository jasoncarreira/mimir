...
def test_poller_does_not_import_mimir():
    ...
    poller_path = SKILL_DIR / "scripts" / "poller.py"
...
def test_scanner_does_not_import_mimir():
    ...
    scanner_path = SKILL_DIR / "scripts" / "scanner.py"
...
def test_poller_runs_without_mimir(tmp_path):
    ...
    This simulates running `python3 scripts/poller.py` from the skill directory
